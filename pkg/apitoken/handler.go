...
var AvailableAdminRoutes = []AvailableRoute{
	...
	{Method: "GET", Path: "/admin/api/applications"},
	{Method: "POST", Path: "/admin/api/applications"},
	{Method: "GET", Path: "/admin/api/applications/{id}"},
	{Method: "PUT", Path: "/admin/api/applications/{id}"},
	{Method: "DELETE", Path: "/admin/api/applications/{id}"},
